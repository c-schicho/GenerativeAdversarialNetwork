...
class Trainer:
    ...
    def __init__(self, l_rate: float, z_dim: int, image_dim: int, generator_path: str,
                 discriminator_path: str, tensorboard_path: str):
        ...
        self.generator = DCGANGenerator(in_dims=z_dim, out_dims=image_dim).to(self.device)
        self.discriminator = DCGANDiscriminator(in_dims=image_dim).to(self.device)
    ...
    def train(self, epochs: int, dataloader: DataLoader, load_model: bool,
